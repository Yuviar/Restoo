<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center "
        ...
        {{-- <div class="w-full py-5 rounded-2xl" style="background: rgba(255, 255, 255,.3); backdrop-filter: blur(5px);"> --}}
            <h1
                ...
                <span class="inline md:block">Welcome To Restoo Restaurant</span>
            </h1>
            <div class="mx-auto mt-2 text-green-100 md:text-center lg:text-lg">
